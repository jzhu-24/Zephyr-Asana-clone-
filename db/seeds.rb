...
ActiveRecord::Base.transaction do
  ...
  Workspace.create(name: "Demo (try me!)")
  ...
  # Task.create(name: "Hire more senior devs", creator_id: User.first.id, column_id: Column.second.id)
  # Task.create(name: "Fix this bug", creator_id: User.first.id, column_id: Column.second.id)
